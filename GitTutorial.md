...
1. Во вкладке Repositories находятся все доступные мне репозитории. Там же указано это публичный или приватный репозиторий, когда был последний апдейт, сколько было сделано "форков".
...
2. Создание нового репозитория.
    ...
    ![скрин с созданием нового репозитория](/YourHomeWork/Pirtures/NewRepository.png    )
