...
### 1. **Вкладка Repository в GitHub**

Во вкладке Repositories находятся все доступные репозитории. Там же указано это публичный или приватный репозиторий, когда был последний апдейт, сколько было сделано "форков".
...
### 5. **Pull request**
    ...
    Запрос на отправку своего репозитория из GitHub другому пользователю GitHub

### 6. **Функция Fork**

    В случае выбора функции Fork депозиторий другого пользователя полностью копируется, после этого в нем можно сделать какие-то изменения и сделать Pull request для отправки измененного репозитория обратно этому пользователю.