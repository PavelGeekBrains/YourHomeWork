...
* *git remote add pb https://github.com/.........* - команда для обозначения репозитория на Git
* *git push* - команда для обновления репозитория при внесении изменений в локальном файле
* *git pull* - команда для обновления репозитория при внесении изменений в удаленном файле (на сайте)
