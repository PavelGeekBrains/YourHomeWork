 ...
 * ## Списки 
  ...
  *git clone ссылка_github* - клонирование удалнённого репозитория по сслыке на локальный компьютер.

 *git remote add origin ссылка_github* - добавляет связь удалённого репозитория с локальным репозиторием.

 *git branch -M main* - указание основной ветки для отправки информации на удалённый репозиторий.

 *git push -u origin main* - команда для  отправки информации, направлюящая содержимое локального репозитория в удалённый репозиторий для слияния.

 *git push* - команда, направлюящая содержимое локального репозитория в удалённый репозиторий для слияния.

 *git push --set upstream origin branch_name* - команда, направлюящая содержимое локального репозитория c не основной ветки в удалённый репозиторий для слияния.

 *git pull* - команда копирования и слияния из удалённого репозитория содержимого на локальный репозиторий.      
